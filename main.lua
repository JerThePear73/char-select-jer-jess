...
-- Jer Dialog
charSelect.character_replace_dialog(CT_JER, DIALOG_129, 1, 5, 40, 200, (
...
\nGive it a Try!"))
charSelect.character_replace_dialog(CT_JER, DIALOG_130, 1, 5, 40, 200, (
...
standstill.\
\nGive it a Try!"))
charSelect.character_replace_dialog(CT_JER, DIALOG_131, 1, 5, 40, 200, (
"Welcome to the Wing-\
...
-- Jess Dialog
charSelect.character_replace_dialog(CT_JESS, DIALOG_130, 1, 5, 40, 200, (
...
figure skating jump!\
\nGive it a Try!"))
charSelect.character_replace_dialog(CT_JESS, DIALOG_131, 1, 5, 40, 200, ( -- don't bother. Dialog doesn't play if you aren't flying
