...
Lights1 davy_cap_Metal__METAL__lights = gdSPDefLights1(
	0xFF, 0xFF, 0xFF,
	0x0, 0x0, 0x0, 0x28, 0x28, 0x28);

Gfx davy_cap_quin_shade_ia8_aligner[] = {gsSPEndDisplayList()};
u8 davy_cap_quin_shade_ia8[] = {
	#include "actors/davy_cap/quin_shade.ia8.inc.c"
};
...
Gfx davy_cap_Metal_Shade_rgba16_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 davy_cap_Metal_Shade_rgba16_rgba16[] = {
	#include "actors/davy_cap/Metal_Shade.rgba16.inc.c"
};

Gfx davy_cap_Metal_Light_rgba16_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 davy_cap_Metal_Light_rgba16_rgba16[] = {
	#include "actors/davy_cap/Metal_Light.rgba16.inc.c"
};
...
Gfx mat_davy_cap_Davy_Cap_Bottom__CAP_[] = {
	...
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_8b_LOAD_BLOCK, 1, davy_cap_quin_shade_ia8),
...
Gfx mat_davy_cap_Metal__METAL_[] = {
	gsSPGeometryMode(G_CULL_BACK, G_TEXTURE_GEN),
	gsSPLight(&davy_cap_Metal__METAL__lights.l, 1),
    gsSPLight(&davy_cap_Metal__METAL__lights.a, 2),
    gsSPCopyLightEXT(2, 15),
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, SHADE, TEXEL1, 0, 0, 0, ENVIRONMENT, TEXEL0, 0, SHADE, TEXEL1, 0, 0, 0, ENVIRONMENT),
	gsSPTexture(4032, 1984, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, davy_cap_Metal_Shade_rgba16_rgba16),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 0, 0, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
	gsDPLoadBlock(7, 0, 0, 2047, 128),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 0, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, 0, G_TX_WRAP | G_TX_NOMIRROR, 6, 0),
	gsDPSetTileSize(0, 0, 0, 252, 124),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, davy_cap_Metal_Light_rgba16_rgba16),
...
Gfx mat_revert_davy_cap_Metal__METAL_[] = {
...
Gfx davy_cap_Normal_Cap_DL_mesh_layer_1_mat_override_Metal__METAL__0[] = {
	gsSPDisplayList(mat_davy_cap_Metal__METAL_),
	gsSPDisplayList(davy_cap_Normal_Cap_DL_mesh_layer_1_tri_0),
	gsSPDisplayList(davy_cap_Normal_Cap_DL_mesh_layer_1_tri_1),
	gsSPDisplayList(davy_cap_Normal_Cap_DL_mesh_layer_1_tri_2),
	gsSPDisplayList(davy_cap_Normal_Cap_DL_mesh_layer_1_tri_3),
	gsSPDisplayList(mat_revert_davy_cap_Metal__METAL_),
	gsSPEndDisplayList(),
};
