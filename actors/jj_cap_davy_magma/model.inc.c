Lights1 jj_cap_davy_magma_Magma_Flower_Stem_lights = gdSPDefLights1(
	0x2E, 0x12, 0x9,
	0x64, 0x2F, 0x1E, 0x28, 0x28, 0x28);

Lights1 jj_cap_davy_magma_Magma_Flower_Leaf_lights = gdSPDefLights1(
	0x2E, 0x12, 0x9,
	0x64, 0x2F, 0x1E, 0x28, 0x28, 0x28);

Gfx jj_cap_davy_magma_DavyMagma_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 jj_cap_davy_magma_DavyMagma_rgba16[] = {
	#include "actors/jj_cap_davy_magma/DavyMagma.rgba16.inc.c"
};

Gfx jj_cap_davy_magma_FlowerEyesMagma_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 jj_cap_davy_magma_FlowerEyesMagma_rgba16[] = {
	#include "actors/jj_cap_davy_magma/FlowerEyesMagma.rgba16.inc.c"
};

Gfx jj_cap_davy_magma_FlowerLeaves_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 jj_cap_davy_magma_FlowerLeaves_rgba16[] = {
	#include "actors/jj_cap_davy_magma/FlowerLeaves.rgba16.inc.c"
};

Vtx jj_cap_davy_magma_Metal_Cap_DL_mesh_layer_1_vtx_0[21] = {
	{{ {0, 0, -36}, 0, {112, 368}, {253, 210, 138, 255} }},
	{{ {0, 0, 28}, 0, {368, 368}, {9, 206, 116, 255} }},
	{{ {-32, 0, -4}, 0, {240, 496}, {175, 96, 239, 255} }},
	{{ {32, 0, -4}, 0, {624, 752}, {55, 145, 228, 255} }},
	{{ {0, 0, -36}, 0, {624, 880}, {253, 210, 138, 255} }},
	{{ {0, 49, -18}, 0, {624, 880}, {255, 40, 136, 255} }},
	{{ {-32, 0, -4}, 0, {624, 752}, {175, 96, 239, 255} }},
	...
	{{ {0, 0, 28}, 0, {624, 368}, {9, 206, 116, 255} }},
	{{ {32, 0, -4}, 0, {624, 496}, {55, 145, 228, 255} }},
	...
	{{ {-32, 0, -4}, 0, {624, 496}, {175, 96, 239, 255} }},
};

Gfx jj_cap_davy_magma_Metal_Cap_DL_mesh_layer_1_tri_0[] = {
	gsSPVertex(jj_cap_davy_magma_Metal_Cap_DL_mesh_layer_1_vtx_0 + 0, 21, 0),
...
Vtx jj_cap_davy_magma_Metal_Cap_DL_mesh_layer_1_vtx_1[45] = {
...
Gfx jj_cap_davy_magma_Metal_Cap_DL_mesh_layer_1_tri_1[] = {
	gsSPVertex(jj_cap_davy_magma_Metal_Cap_DL_mesh_layer_1_vtx_1 + 0, 32, 0),
	...
	gsSPVertex(jj_cap_davy_magma_Metal_Cap_DL_mesh_layer_1_vtx_1 + 32, 13, 0),
...
Vtx jj_cap_davy_magma_Metal_Cap_DL_mesh_layer_5_vtx_0[6] = {
	{{ {0, 139, 57}, 0, {510, 935}, {255, 255, 255, 255} }},
	{{ {57, 139, 37}, 0, {927, 939}, {255, 255, 255, 255} }},
	{{ {80, 214, 65}, 0, {1007, 102}, {255, 255, 255, 255} }},
	{{ {0, 214, 96}, 0, {504, 116}, {255, 255, 255, 255} }},
	{{ {-80, 214, 65}, 0, {1007, 102}, {255, 255, 255, 255} }},
	{{ {-57, 139, 37}, 0, {927, 939}, {255, 255, 255, 255} }},
};

Gfx jj_cap_davy_magma_Metal_Cap_DL_mesh_layer_5_tri_0[] = {
	gsSPVertex(jj_cap_davy_magma_Metal_Cap_DL_mesh_layer_5_vtx_0 + 0, 6, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSP2Triangles(0, 3, 4, 0, 0, 4, 5, 0),
	gsSPEndDisplayList(),
};

Vtx jj_cap_davy_magma_Metal_Cap_DL_mesh_layer_4_vtx_0[15] = {
...
Gfx jj_cap_davy_magma_Metal_Cap_DL_mesh_layer_4_tri_0[] = {
	gsSPVertex(jj_cap_davy_magma_Metal_Cap_DL_mesh_layer_4_vtx_0 + 0, 15, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
...
Gfx mat_jj_cap_davy_magma_Magma_Flower_Stem[] = {
	gsSPSetLights1(jj_cap_davy_magma_Magma_Flower_Stem_lights),
	gsDPPipeSync(),
...
Gfx mat_jj_cap_davy_magma_Magma[] = {
	gsSPGeometryMode(0, G_TEXTURE_GEN),
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, ENVIRONMENT),
	gsSPTexture(4032, 4032, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, jj_cap_davy_magma_DavyMagma_rgba16),
...
Gfx mat_revert_jj_cap_davy_magma_Magma[] = {
	gsSPGeometryMode(G_TEXTURE_GEN, 0),
	gsDPPipeSync(),
	gsSPEndDisplayList(),
};

Gfx mat_jj_cap_davy_magma_Magma_Flower_Eyes[] = {
	...
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, jj_cap_davy_magma_FlowerEyesMagma_rgba16),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 0, 0, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
...
Gfx mat_revert_jj_cap_davy_magma_Magma_Flower_Eyes[] = {
	gsSPGeometryMode(0, G_SHADE | G_LIGHTING),
	gsDPPipeSync(),
	gsSPEndDisplayList(),
};

Gfx mat_jj_cap_davy_magma_Magma_Flower_Leaf[] = {
	gsSPGeometryMode(G_CULL_BACK, 0),
	gsSPSetLights1(jj_cap_davy_magma_Magma_Flower_Leaf_lights),
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, ENVIRONMENT, 0, TEXEL0, 0, SHADE, 0, TEXEL0, 0, ENVIRONMENT, 0),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, jj_cap_davy_magma_FlowerLeaves_rgba16),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 0, 0, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
...
Gfx mat_revert_jj_cap_davy_magma_Magma_Flower_Leaf[] = {
	gsSPGeometryMode(0, G_CULL_BACK),
	gsDPPipeSync(),
	gsSPEndDisplayList(),
};

Gfx jj_cap_davy_magma_Metal_Cap_DL_mesh_layer_1[] = {
	gsSPDisplayList(mat_jj_cap_davy_magma_Magma_Flower_Stem),
	gsSPDisplayList(jj_cap_davy_magma_Metal_Cap_DL_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_jj_cap_davy_magma_Magma),
	gsSPDisplayList(jj_cap_davy_magma_Metal_Cap_DL_mesh_layer_1_tri_1),
	gsSPDisplayList(mat_revert_jj_cap_davy_magma_Magma),
	gsSPEndDisplayList(),
};

Gfx jj_cap_davy_magma_Metal_Cap_DL_mesh_layer_5[] = {
	gsSPDisplayList(mat_jj_cap_davy_magma_Magma_Flower_Eyes),
	gsSPDisplayList(jj_cap_davy_magma_Metal_Cap_DL_mesh_layer_5_tri_0),
	gsSPDisplayList(mat_revert_jj_cap_davy_magma_Magma_Flower_Eyes),
	gsSPEndDisplayList(),
};

Gfx jj_cap_davy_magma_Metal_Cap_DL_mesh_layer_4[] = {
	gsSPDisplayList(mat_jj_cap_davy_magma_Magma_Flower_Leaf),
	gsSPDisplayList(jj_cap_davy_magma_Metal_Cap_DL_mesh_layer_4_tri_0),
	gsSPDisplayList(mat_revert_jj_cap_davy_magma_Magma_Flower_Leaf),
	gsSPEndDisplayList(),
};

Gfx jj_cap_davy_magma_material_revert_render_settings[] = {
	gsDPPipeSync(),
