...
const GeoLayout davy_wing_cap_Wing_Cap_Switch_opt1[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_NODE_START(),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, davy_wing_cap_Wing_Cap_mesh_layer_1),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, davy_wing_cap_Wings_mesh_layer_4),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
...
const GeoLayout davy_wing_cap_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					...
					GEO_OPEN_NODE(),
						GEO_NODE_START(),
						GEO_OPEN_NODE(),
							GEO_DISPLAY_LIST(LAYER_OPAQUE, davy_wing_cap_Wing_Cap_mesh_layer_1),
							GEO_DISPLAY_LIST(LAYER_ALPHA, davy_wing_cap_Wings_mesh_layer_4),
						GEO_CLOSE_NODE(),
					GEO_CLOSE_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, davy_wing_cap_material_revert_render_settings),
		GEO_DISPLAY_LIST(LAYER_ALPHA, davy_wing_cap_material_revert_render_settings),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, davy_wing_cap_material_revert_render_settings),
	GEO_CLOSE_NODE(),
	GEO_END(),
};
