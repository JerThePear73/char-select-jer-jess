...
const GeoLayout j_cap_Normal_Cap_State_Switch_opt1[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, j_cap_Normal_Cap_DL_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, j_cap_Normal_Cap_DL_mesh_layer_4),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					GEO_NODE_START(),
					GEO_OPEN_NODE(),
						GEO_DISPLAY_LIST(LAYER_OPAQUE, j_cap_Normal_Cap_DL_mesh_layer_1),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, j_cap_material_revert_render_settings),
		GEO_DISPLAY_LIST(LAYER_ALPHA, j_cap_material_revert_render_settings),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, j_cap_material_revert_render_settings),
	GEO_CLOSE_NODE(),
	GEO_END(),
};
